...
$users = $pdo->query("SELECT u.*, r.libelle as role_nom 
                      FROM utilisateur u 
                      LEFT JOIN role r ON u.roleID = r.id 
                      ORDER BY u.nom ASC")->fetchAll(PDO::FETCH_ASSOC);
?>
...
<div class="card shadow-sm border-0">
    <div class="card-header text-white fw-bold" style="background-color: #486a70;">
        <i class="fas fa-list me-2"></i>Répertoire du Personnel
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group shadow-sm">
                                ...
                                <button class="btn btn-sm btn-danger delete-btn" data-id="<?= $u['id'] ?>" data-nom="<?= htmlspecialchars($u['username']) ?>">
